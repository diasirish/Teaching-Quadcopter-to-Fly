...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=64, kernel_regularizer=regularizers.l2(1e-6))(states)
        net_states = layers.BatchNormalization()(net_states)
        net_states = layers.Activation('tanh')(net_states)

        # Add hidden layer(s) for action pathway
        net_states = layers.Dense(units=64, kernel_regularizer=regularizers.l2(1e-6))(net_states)
        net_actions = layers.Dense(units=64, kernel_regularizer=regularizers.l2(1e-6))(actions)
